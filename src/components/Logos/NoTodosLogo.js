...
const NoTodoLogo = () => {
    ...
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg" className="svg-icon" style={{ width: '6em', height: '6em', verticalAlign: 'middle', fill: 'white', overflow: 'hidden', marginTop: '80px' }} viewBox="0 0 1024 1024" version="1.1">
            ...
            <p style={{color:'white', fontSize:'28px', fontWeight:'800'}}>No todos found</p>
        </>
    );
};
